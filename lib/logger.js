...
function Logger (options) {
  ...
  if (this.type === 'forward') {
    ...
    this.writeStream = PROTOCOLS[this.protocol].request(this.httpOptions, function (res) {})
...
Logger.prototype._write = function (data, encoding) {
